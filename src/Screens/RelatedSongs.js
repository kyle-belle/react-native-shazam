...
import { View, Text, Image, Alert, ScrollView, FlatList, TouchableOpacity, Dimensions, StyleSheet } from 'react-native';
...
const RelatedSongs = ({song, loading_song, playing_song}) => {
    ...
    return (
        <FlatList style={[StyleSheet.absoluteFill, {zIndex: 5}]} ListHeaderComponent={() => {
            return (
